...
<c:set var="picPath" value="http://localhost:8002/ssm_Image_war_exploded/"></c:set>
...
<body>
<form id="itemForm" action="${pageContext.request.contextPath }/items/updateItem.do" method="post" >
